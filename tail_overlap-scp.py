...
#if len(sys.argv) < 4:
#    print("Usage: python3 tail_overlap.py daughter_filename parent_filename overlap_filename")
#    sys.exit(1)
...
parser.add_argument('r', '--r-dependence', type=str, default='false', help='true to perform r-independent tail overlaps for. When true, single point overlap will be calculated for given distance. False will calculate the r-dependent overlaps for the given range of potential')
